...
namespace BJUTDUHelperXamarin.Views.MyBJUT
{
    public partial class UserPage : ContentPage
    {
        ...
        private void UserPage_Appearing(object sender, System.EventArgs e)
        {
            ...
            this.switchProxy.Toggled += CellProxy_OnChanged;
        }
   ...
   BindableProperty.CreateAttached("TappedCommand", typeof(ICommand), typeof(Switch), null, defaultBindingMode: BindingMode.OneWay);
        ...
        {
            GetTappedCommand(switchProxy)?.Execute(null);
        }
